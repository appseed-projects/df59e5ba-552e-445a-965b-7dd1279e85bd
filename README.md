...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-27 12:06`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/df59e5ba-552e-445a-965b-7dd1279e85bd.git
$ cd df59e5ba-552e-445a-965b-7dd1279e85bd
```
